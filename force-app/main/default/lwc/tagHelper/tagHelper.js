...
const quickSearchString = (term, stock)=>{
    ...
    stock != null ? searchString += ' and Product__r.Stock_Status__c  = \''+stock+'\' order by Product__r.Product_Status__c  asc nulls last)' :searchString += ' order by Product__r.Product_Status__c  asc nulls last)'; 
    return searchString; 
  }
  ...
  stock != null ? searchString += ' and Stock_Status__c  = \''+stock+'\' order by Product__r.Product_Status__c  asc nulls last)' :searchString += ' order by Product__r.Product_Status__c  asc nulls last)'; 
